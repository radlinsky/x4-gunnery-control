...
| Paranid L Beam candidate-channel-0 semantics (Issue #72) | [paranid-l-beam-channel0-semantics.md](paranid-l-beam-channel0-semantics.md) | X4 9.00 offline result: position/translation is UNPROVEN; X4Converter says `posKeys`/`location`, but checked shipped and official sources do not independently establish that semantic |
