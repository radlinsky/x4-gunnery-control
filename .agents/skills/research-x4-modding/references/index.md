...
| Rank-2 settled `turret_active` transform | [turret-rank2-settled-active-transform.md](turret-rank2-settled-active-transform.md) | X4 9.00 source-derived, not-live-tested candidate: additive local-X ±35° channel-1 deltas yield one generic two-endpoint transform rule across all seven components |
