...
- Sources: `ui/addons/ego_viewhelper/viewhelper.lua:101-168,191-203`;
...
- Status: shipped-source
- Sources: `ui/addons/ego_viewhelper/viewhelper.lua:101-168`;
...
## Normal world right-click cannot be redirected early, but does not need to be

- Status: shipped-source
- Sources: `ui/core/lua/targetsystem.lua:1212-1319,3999-4011,4357-4377`;
...
- Sources: UI Extensions 9.00 `ui/addons/ego_detailmonitorhelper/helper.xpl`;
...
- Status: shipped-source
- Sources: `ui/addons/ego_interactmenu/menu_interactmenu.lua:342-344,3414-3435,7725-7750`;
...
## Fullscreen tracking is the behavior-based takeover discriminator

- Status: shipped-source
- Sources: `ui/addons/ego_detailmonitorhelper/helper.lua:1331-1436,1907`;
...
- Status: inference bounded by shipped call patterns and FFI signatures
- Finding: `IsFullscreenMenuDisplayed(true, "")` is the intended name-independent
  query for whether any displayed tracked menu is classified fullscreen;
...
- Status: shipped-source
- Sources: `ui/addons/ego_detailmonitorhelper/helper.lua:1423-1436,1907`;
