...
| Auto-engage | Checked mutable groups temporarily use `attackenemies` + staged Armed; unchecked mutable groups use staged Mode/Armed; Direct-control policy ignored; session exit restores baseline; Next/Prev cycles/wraps and is greyed with one operational turret |
