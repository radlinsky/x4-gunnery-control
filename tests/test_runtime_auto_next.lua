...
do
    ...
    do
        ...
        local zeros = {}
        for _, key in ipairs(batches[1].targets) do zeros[key] = false end
        ...
        for i = mark, #fix.uiTriggeredEvents do
            local e = fix.uiTriggeredEvents[i]
            if e.control == "engageability_range"
        ...
        deliver42(batches[1], { ["722"] = false, ["723"] = false, ["724"] = true })
        softtargetCalls42 = {}
        tick42()
    ...
    do
        ...
        assert(#batches == 1 and #batches[1].targets == 2
            ...
            .. table.concat(batches[1] and batches[1].targets or {}, ","))
        deliver42(batches[1], { ["98"] = false, ["99"] = true })
        softtargetCalls42 = {}
        tick42()
