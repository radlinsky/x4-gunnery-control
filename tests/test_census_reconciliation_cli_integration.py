#!/usr/bin/env python3
"""Focused synthetic reconciliation and CLI integration tests for the Issue #72 A2.1 census."""
...
from census_common import CensusError, REQUIRED_SOURCE_SETS, render_json  # noqa: E402
from census_reconciliation import build_reconciliation  # noqa: E402
from census_turret_assets import main  # noqa: E402
...
class CensusReconciliationCliIntegrationTests(unittest.TestCase):
