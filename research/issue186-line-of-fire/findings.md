...
| correct UNKNOWN | 6 |
| missing UNKNOWN (definite where truth is UNKNOWN) | 1 |
| excessive UNKNOWN | 0 |
| max LOS queries, non-guided pair (limit 4) | 3 |
| max LOS queries, guided / UNKNOWN-weapon pair (limit 0) | 0 |
| total simulated LOS queries | 141 |
| centre result differing from the hidden authored-point result | 1 |
...
|---|---:|---:|---:|---:|
| CONVENTIONAL_STRAIGHT_PATH | 27 | 25 | 3 | 2 |
...
| mine (representative small object) | 3 | 2 | 0 | 0 |
...
| offline scene undecidable | 0 | 0 | 2 | 0 |
...
| geometry-predicted aimed muzzle | 29 | 29 | 5 | 0 |
